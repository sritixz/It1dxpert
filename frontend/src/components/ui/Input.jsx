...
export function Input({ label, error, id, className = "", ...props }) {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        id={inputId}
        className={`w-full rounded-lg border bg-surface px-3.5 py-2.5 font-body text-sm text-ink placeholder:text-muted/60 focus:border-primary focus:ring-1 focus:ring-primary transition-colors ${
