      ...
      <div className="lg:col-span-2 space-y-6">
        <Card>
          <div className="flex items-center justify-between border-b border-border pb-4">
            ...
            <span className="text-xs font-semibold text-primary bg-primary-light px-2.5 py-1 rounded-full">3 Entries</span>
          </div>
          <div className="mt-6 space-y-6 relative before:absolute before:left-3.5 before:top-2 before:bottom-2 before:w-0.5 before:bg-border">
            ...
            <div className="flex gap-4 relative">
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-green-100 text-green-700 z-10 border-4 border-surface">
                <Check size={12} strokeWidth={3} />
              </div>
              <div className="flex-1">
                <div className="flex items-baseline justify-between">
                  <h4 className="text-sm font-bold text-ink">Breakfast Log</h4>
                  <span className="text-xs text-muted">08:30 AM</span>
                </div>
                <div className="mt-2 flex gap-4 text-xs font-medium text-muted">
                  <span>Glucose: <strong className="text-ink">108 mg/dL</strong></span>
                  <span>Carbs: <strong className="text-ink">45g</strong></span>
                  <span>Insulin: <strong className="text-ink">4 U (Novorapid)</strong></span>
                </div>
              </div>
            </div>
            ...
            {/* Timeline Item 2 */}
            <div className="flex gap-4 relative">
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-amber-100 text-amber-700 z-10 border-4 border-surface">
                <AlertTriangle size={12} strokeWidth={3} />
              </div>
              <div className="flex-1">
                <div className="flex items-baseline justify-between">
                  <h4 className="text-sm font-bold text-ink">Pre-Lunch Glucose</h4>
                  <span className="text-xs text-muted">01:15 PM</span>
                </div>
                <div className="mt-2 flex gap-4 text-xs font-medium text-muted">
                  <span>Glucose: <strong className="text-amber-600 font-bold">142 mg/dL</strong> (Slightly High)</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 relative">
              ...
              <div className="flex-1">
                <div className="flex items-baseline justify-between">
                  <h4 className="text-sm font-bold text-ink">Post-Lunch Exercise</h4>
                  <span className="text-xs text-muted">02:30 PM</span>
                </div>
                <div className="mt-2 flex gap-4 text-xs font-medium text-muted">
                  <span>Duration: <strong className="text-ink">30 mins (Brisk Walk)</strong></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <Card className="h-full">
          ...
          <form className="mt-6 space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              ...
              <input type="number" placeholder="e.g. 110" className="w-full rounded-lg border border-border bg-bg px-4 py-2.5 text-sm outline-none focus:border-primary" />
            </div>
            <div>
              <label className="block text-xs font-semibold text-muted uppercase tracking-wider mb-2">Carb Intake (grams)</label>
              <input type="number" placeholder="e.g. 30" className="w-full rounded-lg border border-border bg-bg px-4 py-2.5 text-sm outline-none focus:border-primary" />
            </div>
            <div>
              <label className="block text-xs font-semibold text-muted uppercase tracking-wider mb-2">Insulin Dose (units)</label>
              <div className="flex gap-2">
                <input type="number" placeholder="Units" className="w-1/2 rounded-lg border border-border bg-bg px-4 py-2.5 text-sm outline-none focus:border-primary" />
                <select className="w-1/2 rounded-lg border border-border bg-bg px-2 py-2.5 text-sm outline-none focus:border-primary">
                  <option>Novorapid (Rapid)</option>
                  <option>Lantus (Basal)</option>
                </select>
              </div>
            </div>
            <button className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary hover:bg-primary-dark text-white font-medium py-3 text-sm transition-colors mt-2">
